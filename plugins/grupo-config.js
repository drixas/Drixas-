let handler = async (m, { conn, args, usedPrefix, command }) => {
  ...
  if (isClose === 'not_announcement') {
    m.reply(`🔓 𝐄𝐥 𝐠𝐫𝐮𝐩𝐨 𝐞𝐬𝐭𝐚́ 𝐀𝐁𝐈𝐄𝐑𝐓𝐎, 𝐭𝐨𝐝𝐨𝐬 𝐩𝐮𝐞𝐝𝐞𝐧 𝐞𝐬𝐜𝐫𝐢𝐛𝐢𝐫 𝐨𝐭𝐫𝐚 𝐯𝐞𝐳 𝐪𝐮𝐞 𝐟𝐚𝐬𝐭𝐢𝐝𝐢𝐨.`);
  }

  if (isClose === 'announcement') {
    m.reply(`🔒 𝐄𝐥 𝐠𝐫𝐮𝐩𝐨 𝐡𝐚 𝐬𝐢𝐝𝐨 𝐂𝐄𝐑𝐑𝐀𝐃𝐎 𝐜𝐢𝐞𝐫𝐫𝐞𝐧 𝐞𝐥 𝐨𝐫𝐭𝐨, 𝐬𝐨𝐥𝐨 𝐥𝐨𝐬 𝐩𝐞𝐧𝐝𝐞𝐣𝐨𝐬 𝐝𝐞 𝐥𝐨𝐬 ?𝐝𝐦𝐢𝐧𝐬 𝐩𝐮𝐞𝐝𝐞𝐧 𝐞𝐬𝐜𝐫𝐢𝐛𝐢𝐫.`);
  }
};
